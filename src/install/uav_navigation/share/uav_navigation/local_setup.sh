...
: ${AMENT_CURRENT_PREFIX:="/home/batoddy/uav_ws/src/install/uav_navigation"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/uav_navigation/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/uav_navigation/environment/path.sh"
